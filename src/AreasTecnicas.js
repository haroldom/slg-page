...
const AreasTecnicas = () => {
    const areasTecnicas = [
        {
            ...
            description: "La tecnología e informática son clave para el futuro. Sumérgete en el mundo de la tecnología y descubre la programación.",
        },
        {
            ...
            description: "La mecánica automotriz es fundamental para el futuro de la movilidad. Sumérgete en el apasionante mundo de la mecánica de vehículos y descubre cómo mantener y reparar automóviles con destreza y precisión.",
        },
        {
            image: 'https://www.senati.edu.pe/sites/default/files/2017/carrera/09/mecanica-de-produccion-1800-x-1190.jpg',
            name: "Mecánica de Producción",
    ...
    return (
        <div className="areasTecnicas-slide-container" id='areastec' data-aos="fade-up" data-aos-duration="800" data-aos-delay="1000">
